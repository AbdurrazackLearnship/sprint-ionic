  ...
  return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
          <IonTitle>
            <img className="logo-icon" src="assets/Logo-Animation-Alpha.gif" />
          </IonTitle>
        </IonToolbar>
      </IonHeader>
            ...
            <form className="login-form" noValidate autoComplete="off">
              <IonItem>
                ...
                <IonInput
                  color="secondary"
                  onIonChange={(e: any) =>
                    setLoginUsernameInput(e.detail.value)
                  }
                  id="lEmail"
                ></IonInput>
              </IonItem>
              <IonItem>
                ...
                <IonInput
                  ...
                  color="secondary"
                  onIonChange={(e: any) =>
                    setLoginPasswordInput(e.detail.value)
                  }
                  id="lEmail"
                ></IonInput>
              </IonItem>
